...
https://github.com/hotStawbi/mooncraft
https://drive.google.com/file/d/1HtKDeWiioRO7aQsRnzTHRCCMT4CG9o--/view?usp=sharing 
...
### TO FIX THIS YOU CAN RIGHT CLICK ON THE PREVIOUS INSTANCE OF MINECRAFT (Mooncraft_1.1) , CLICK "Folder", ENTER THE "minecraft" FOLDER, AND FIND THE FOLDER CALLED "journeymap" AS WELL AS A FOLDER CALLED "waypoints" AND COPY THEM. THEN RIGHTCLICK THE NEW INSTANCE (Mooncraft_1.2), CLICK "Folder",  ENTER THE "minecraft" FOLDER , AND PASTE THE FOLDERS IN THERE, OVERWRITING WHEN NECESSARY.
